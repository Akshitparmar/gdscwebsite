...
const Privacy = () => {
  return (
    <div className="conatiner privacy-content mx-auto">
      <div className="row privacy-heading">
        <h2 className="privacy-main-heading">Privacy Policy</h2>
      </div>
      <div className="row">
        <div className="privacy-paragraph">
          <p>
            <h3 className="sub-heading-privacy">Privacy Policy for GDSC SRM Ghaziabad </h3>
            At GDSC SRM Ghaziabad, accessible at , one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by GDSC SRM Ghaziabad and how we use it. If you have additional questions
            or require more information about our Privacy Policy, do not
            hesitate to contact us through email at teamistesrmncr@gmail.com
            This privacy policy applies only to our online activities and is
            valid for visitors to our website with regards to the information
            that they shared and/or collect in GDSC SRM Ghaziabad. This policy is not
            applicable to any information collected offline or via channels
            other than this website.
            <h3 className="sub-heading-privacy">Consent</h3>
            By using our website, you hereby consent to our Privacy Policy and
            agree to its terms.
            <h3 className="sub-heading-privacy">Information we collect</h3>
            ...
            number.
            <h3 className="sub-heading-privacy">How we use your information</h3>
            ...
            <h3 className="sub-heading-privacy">Log Files</h3>
            ISTE follows a standard procedure of using log files. These files
            ...
            information.
            <h3 className="sub-heading-privacy">Cookies and Web Beacons</h3>
            Like any other website, GDSC SRM Ghaziabad uses ‘cookies'. These cookies are used
            ...
            information.
            <h3 className="sub-heading-privacy">DoubleClick DART Cookie</h3>
            ...
            <h3 className="sub-heading-privacy">
              Advertising Partners Privacy Policies
            </h3>
            You may consult this list to find the Privacy Policy for each of the
            advertising partners of GDSC SRM Ghaziabad.
            <br />
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on GDSC SRM Ghaziabad, which are
            ...
            <br />
            Note that GDSC SRM Ghaziabad has no access to or control over these cookies that
            are used by third-party advertisers.
            <h3 className="sub-heading-privacy">
              Third-Party Privacy Policies
            </h3>
            GDSC SRM Ghaziabad Privacy Policy does not apply to other advertisers or websites.
            ...
            <h3 className="sub-heading-privacy">Children's Information</h3>
            Another part of our priority is adding protection for children while
            using the internet. We encourage parents and guardians to observe,
            participate in, and/or monitor and guide their online activity. GDSC SRM Ghaziabad
